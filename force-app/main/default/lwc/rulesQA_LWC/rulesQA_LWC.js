...
export default class RulesQA_LWC extends LightningElement {
    ...
    @wire(getRulesListRESTCalloutFct, 
        // Dynamic parameter doesn't work with Quick Action
        // { sType : '$ruleType'}
        { sType : 'Travel-Approval'}
    )
    wiredGetRulesListRESTCalloutFct(result) {
        console.log('### Rules_LWC - wiredGetRulesListRESTCalloutFct() - START');
        console.log('### Rules_LWC - wiredGetRulesListRESTCalloutFct() - result:' + JSON.stringify(result));
